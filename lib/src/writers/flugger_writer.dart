...
class FluggerWriter {
  ...
  Future<void> writeToFileAndAddExport(String path, String content) async {
    await writeToFile(path, content);
    await addExport(path);
  }
  ...
  Future<void> addExport(String path) async {
    final pathParts = path.split('/');

    final pathParent = List<String>.from(pathParts)..removeLast();

    final barrelFilePath = '${pathParent.join('/')}/_all.dart';

    // TODO: Finish this
    // appendToFile(barrelFilePath, );
  }
